...
# Class definitions based on the provided tutorial and datamodel.py snippet
...
# Note: Actual trading logic should be implemented in the Trader class's run method according to competition rules.
